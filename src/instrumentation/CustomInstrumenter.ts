...
import programVisitor from "./CustomVisitor";
const readInitialCoverage = require('istanbul-lib-instrument/src/read-coverage');
...
export class CustomInstrumenter {
  private opts: any;
  private fileCoverage: any;
