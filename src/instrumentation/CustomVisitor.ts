...
const { SourceCoverage } = require('istanbul-lib-instrument/src/source-coverage');
const { SHA, MAGIC_KEY, MAGIC_VALUE } = require('istanbul-lib-instrument/src/constants');
 ...
 * original code.
 */
export default function programVisitor(types, sourceFilePath = 'unknown.js', opts: VisitorOptions = {}) {
  const T = types;
  opts = {
