import {CFG, ObjectiveFunction, SearchSubject, TestCase, ActionDescription} from "../../src";
...
export class DummySearchSubject extends SearchSubject<TestCase>{
    ...
    protected _objectives: Map<ObjectiveFunction<TestCase>, ObjectiveFunction<TestCase>[]>;
    ...
    getChildObjectives(objective: ObjectiveFunction<TestCase>): ObjectiveFunction<TestCase>[] {
        return [];
    }
    ...
    getPossibleActions(type: string | undefined, returnType: string | undefined): ActionDescription[] {
        return [];
    }
